...
headers = {
    ...
    'Cookie':'MEIQIA_EXTRA_TRACK_ID=0070956c107b11e7a7c00246fd076266; PHPSESSID=ugmp68m7sapkupis94k648lrf1; ad_index_dialog=1; WAF_SESSION_ID=b8514f16fd95b1631883520236d6d0bf; WAF_SESSION_ID=bab102af41335d8ffff66e4f4359b7ed; think_language=zh-CN; UtzD_f52b_saltkey=U2HR3HHx; UtzD_f52b_lastvisit=1491560891; UtzD_f52b_ulastactivity=1489737935%7C0; _gat=1; UtzD_f52b_creditnotice=0D0D2D0D0D0D0D0D0D371681; UtzD_f52b_creditbase=0D0D457D0D0D0D0D0D0; UtzD_f52b_creditrule=%E6%AF%8F%E5%A4%A9%E7%99%BB%E5%BD%95; mylogin=1; _ga=GA1.2.714695514.1490350613; yaozh_logintime=1491628323; yaozh_user=385042%09gjpharm; yaozh_userId=385042; db_w_auth=371681%09gjpharm; UtzD_f52b_lastact=1491628323%09uc.php%09; UtzD_f52b_auth=f1782m%2Bn%2F9BUefJk%2FkMB8FjkF9DcUj15diIglW%2B0wnRv8hb4kMUSARCoyT3%2FgM0jyyH5oFXMyf%2FpDwr12i6w8O1WF3k; _ga=GA1.3.714695514.1490350613; Hm_lvt_65968db3ac154c3089d7f9a4cbb98c94=1490350613%2C1491564485; Hm_lpvt_65968db3ac154c3089d7f9a4cbb98c94=1491628577; zbpreid=',
    'Host':'db.yaozh.com',
...
def get_url():
    ...
    for d in data:
        ...
        try:
            proxies = get_ip()
            # proxies = {'https': 'https://111.13.109.27:80', 'http': 'http://111.13.109.27:80'}
